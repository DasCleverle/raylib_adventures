// Taken from https://github.com/mgerhold/lib2k/blob/main/src/include/lib2k/unique_value.hpp
...
private:
    ...
    CAT_NO_UNIQUE_ADDRESS Deleter m_deleter;
...
public:
    ...
    ~UniqueValue() noexcept {
        // this static_assert is inside the destructor since the destructor is
